...
// import etlRules from '../../../scripts/package-downloader/tmp/npm/ember-template-lint/node_modules/ember-template-lint/lib/rules/index.js';
// import etlConfigurations from '../../../scripts/package-downloader/tmp/npm/ember-template-lint/node_modules/ember-template-lint/lib/config/index.js';

/**
 * Load the linters/packages downloaded locally the package-downloader script into the database.
 */
