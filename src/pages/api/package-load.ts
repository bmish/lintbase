...
// import etlRules from './tmp/npm/ember-template-lint/node_modules/ember-template-lint/lib/rules/index.js';
// import etlConfigurations from './tmp/npm/ember-template-lint/node_modules/ember-template-lint/lib/config/index.js';

/**
 * Load the linters/packages that were downloaded locally into the database.
 */
export default async function packageLoad(
  req: NextApiRequest,
  res: NextApiResponse,
) {
